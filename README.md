...
Тем не менее вот мой текущий набор, собранный за те часы, которые я мог бы потратить на что-то полезное.

### Что здесь происходит

- Темы: WhiteSur во всех возможных оттенках депрессии и MacTahoe, потому что один вариант — это слишком мало
- Иконки: La Capitaine — классика, которая постарела лучше, чем я
- Шрифт: SF Pro Display 11 — потому что «Inter» для слабаков
